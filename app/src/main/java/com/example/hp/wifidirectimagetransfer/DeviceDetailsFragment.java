...
public class DeviceDetailsFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentView = inflater.inflate(R.layout.fragment_device_details, null);
...
//                        startActivityForResult(intent, CHOOSE_FILE_RESULT_CODE);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(MainActivity.TAG, "Intent----------- " + uri.toString());
        Intent serviceIntent = new Intent(getActivity(), FileTransferService.class);
        serviceIntent.setAction(FileTransferService.ACTION_SEND_FILE);
        serviceIntent.putExtra(FileTransferService.EXTRAS_FILE_PATH, uri.toString());
        serviceIntent.putExtra(FileTransferService.EXTRAS_GROUP_OWNER_ADDRESS,
    ...
    public static class FileServerAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                final File f = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/wifidirectfiles/"
